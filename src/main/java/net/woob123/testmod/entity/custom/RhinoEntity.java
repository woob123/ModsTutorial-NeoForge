package net.woob123.testmod.entity.custom;
...
import net.woob123.testmod.entity.ai.RhinoAttackGoal;
...
public class RhinoEntity extends Animal {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new TemptGoal(this, 1.5D, Ingredient.of(ModItems.CORN.get()), false));
